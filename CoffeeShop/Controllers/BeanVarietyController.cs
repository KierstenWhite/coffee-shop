...
//Right-click on the Controllers folder in the Solution Explorer and select Add -> Controller....
//In the dialog box that appears, select API on the left panel.
//Next select API Controller - Empty in the center panel.
